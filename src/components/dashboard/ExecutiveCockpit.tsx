...
export function ExecutiveCockpit() {
  const handleKPIClick = (kpiName: string) => {
    ...
    // Hier würde normalerweise Navigation zu Detail-Views erfolgen
  };
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <KPICard
            ...
            onClick={() => handleKPIClick('logistikkosten')}
          />
          ...
          <KPICard
            ...
            onClick={() => handleKPIClick('termintreue')}
          />
          ...
          <KPICard
            ...
            onClick={() => handleKPIClick('lagerumschlag')}
          />
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {quickStats.map((stat, index) => (
            <KPICard
              ...
              status={stat.status}
              icon={stat.icon}
              onClick={() => handleKPIClick(stat.label.toLowerCase())}
            />
          ))}
        </div>
      </div>
